...
class StringNotifier extends ObjectNotifier<String> implements Comparable<String>, Pattern {
...
class NStringNotifier extends ObjectNotifier<String?> implements Comparable<String>, Pattern {
  NStringNotifier([String? value]) : super(value);
