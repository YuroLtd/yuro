...
class SwitcherState extends State<Switcher> {
  ...
  Widget build(BuildContext context) {
    ...
    if (showChild != null) {
      showChild = Positioned(
        left: isOpen ? widget.childOffset : null,
        right: isOpen ? null : widget.childOffset,
        child: showChild,
      );
    ...
    var slider = AnimatedContainer(
        ...
        width: circleSize + ((drag && sliderOffset != maxOffset) ? sliderDragW : 0),
        height: circleSize,
        child: Container(
  ...
  void _handlerOnHorizontalDragCancel() => setState(() => drag = false);
}
