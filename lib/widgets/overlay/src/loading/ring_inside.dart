...
class RingInsideState extends State<RingInside> with SingleTickerProviderStateMixin {
  ...
  Color get backgroudColor => widget.backgroudColor ?? Theme.of(context).colorScheme.surfaceVariant;
...
class _RingPainter extends CustomPainter {
  ...
  bool shouldRepaint(covariant _RingPainter old) =>
      startAngle != old.startAngle || color != old.color || backgroudColor != old.backgroudColor || strokenWidth != old.strokenWidth;
}
